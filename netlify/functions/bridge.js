...
function buildOpenApiSpec(baseUrl) {
  ...
  return {
    openapi: '3.1.0',
    info: {
      title: 'A11y Personas MCP API',
      description: 'REST bridge for a11y-personas MCP tools. List and get detailed accessibility personas for inclusive design and development.',
      version: '1.0.0',
    },
    servers: [{ url: baseUrl }],
    paths,
